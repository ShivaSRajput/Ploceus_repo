...
vnets_variables = {
  "vnet_1" = {
    name                        = "ploceusvnet000261a"
    location                    = "westus2"
    resource_group_name         = "ploceusrg000261"
...
subnet_variables = {
  "subnet_1" = {
    name                                           = "ploceussubnet000261a"
    resource_group_name                            = "ploceusrg000261"
    address_prefixes                               = ["10.0.1.0/24"]
    virtual_network_name                           = "ploceusvnet000261a"
...
public_ip_variable = {
  "public_ip_1" = {
    ...
    sku                     = "Standard"
    sku_tier                = "Regional"
    public_ip_dns           = "ploceuspublicip000261a"
...
application_gateway_variables = {
  "application_gateway_1" = {
    name                           = "ploceusapgw000261a"
    resource_group_name            = "ploceusrg000261"
    location                       = "westus2"
    sku_name                       = "Standard_v2"
    sku_tier                       = "Standard_v2"
    sku_capacity                   = 1
    gateway_ip_configuration_name  = "apgw000261a-gicconfig"
    vnet_name                      = "ploceusvnet000261a"
    subnet_name                    = "ploceussubnet000261a"
    frontend_port_name             = "apgw000261a-feip"
    frontend_port                  = 80
    frontend_ip_configuration_name = "apgw000261a-feipconfig"
    is_private_fronted_ip_required = false
    private_ip_address             = null
    is_public_fronted_ip_required  = true
    public_ip_name                 = "ploceuspublicip000261a"
...
key_vault_key_variables = {
  "key_vault_key_1" = {
    name                = "ploceuskey000261a1"
    resource_group_name = "ploceusrg000261"
    key_vault_name      = "ploceuskeyvault000261a1"
    key_type            = "RSA"
    key_size            = 2048
    curve               = null
...
disk_encryption_set_variables = {
  "disk_encryption_set_1" = {
    name                      = "ploceuploceusdiskencryptionset000261a1"
    resource_group_name       = "ploceusrg000261"
    location                  = "westus2"
    key_vault_name            = "ploceuskeyvault000261a1"
    key_vault_key_name        = "ploceuskey000261a1"
...
nsg_association_variable = {
  "nsg_association_variable_1" = {
    nic_association = [
      {
        nic_name            = "ploceusnic000261a"
        nsg_to_associate    = "ploceusnsg000261a"
        resource_group_name = "ploceusrg000261"
      }
    ]
...
#     admin_ssh_key_vault_name                        = "ploceuskeyvault000261a2" #"existingkeyvaultscenario" #"ploceuskeyvault000261b"
...
#     admin_ssh_key_vault_secret_name                 = "adminsshprivatewindowsvm1"
    license_type                                    = null
    vm_nic_keys                                     = ["windows_vm_1_nic_1"]
    computer_name                                   = "ploceusvm000261"
    ...
    priority                                        = null
    os_disk_name                                    = "ploceusosdisk000261a"
    os_disk_caching                                 = null
    os_disk_storage_account_type                    = "Standard_LRS"
    is_disk_encryption_set_required                 = false                             ######################
    disk_encryption_set_name                        = "ploceusdiskencryptionset000261a" ######################
    ...
    boot_diagnostics_storage_account_name           = "ploceusbootdiag000261a"
