...
vpn_server_configuration_policy_group_variables = {
  "vpn_server_configuration_policy_group1" = {
  name                        = "ploceusvpnscpg00001"
  resource_group_name      = "ploceusrg00001"
  vpn_server_configuration_id = "ploceusvpnsc00001"
  is_default                  = false
  priority                    = "0"
  policy = [{
    name  = "policy1"
