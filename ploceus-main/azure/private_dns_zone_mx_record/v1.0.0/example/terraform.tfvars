...
private_dns_zone_mx_records = {
  "mx1" = {
    name                = "ploceusprivatednsmx00001"
    zone_name           = "ploceusprivatedns00001.com" #Should be same as Zone name
    resource_group_name = "ploceusrg00001"
    ttl                 = 100
    records = [{
      preference = 10
          exchange = "ploceusprivatednsmx00001-1.ploceusprivatedns00001.com"
      },
      {
        preference = 20
          exchange = "ploceusprivatednsmx00001-2.ploceusprivatedns00001.com"
    }]
    tags = {
      Created_By = "Ploceus",
      Department = "CIS"
