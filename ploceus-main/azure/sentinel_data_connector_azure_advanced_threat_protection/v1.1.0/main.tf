data "azurerm_log_analytics_workspace" "log_analytics_workspace" {
  for_each            = var.sentinel_data_connector_azure_advanced_threat_protection_variables
...
resource "azurerm_sentinel_data_connector_azure_advanced_threat_protection" "sentinel_data_connector_azure_advanced_threat_protection" {
  for_each                   = var.sentinel_data_connector_azure_advanced_threat_protection_variables
  name                       = each.value.sentinel_data_connector_azure_advanced_threat_protection_name
