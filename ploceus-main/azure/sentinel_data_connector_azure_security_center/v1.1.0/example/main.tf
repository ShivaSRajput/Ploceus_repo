...
module "sentinel_data_connector_azure_security_center" {
  source                       = "../"
 sentinel_data_connector_azure_security_center_variables = var.sentinel_data_connector_azure_security_center_variables
  depends_on = [
