...
#Virtual Hub
module "virtual_hub_bgp_connection" {
  source                               = "../"
  virtual_hub_bgp_connection_variables = var.virtual_hub_bgp_connection_variables
  depends_on = [
    module.virtual_hub,
    module.virtual_hub_ip #Required to create a BGP connection
  ]
}
