...
postgresql_server_variables = {
  "postgresql_server_1" = {
    ...
    postgresql_server_location            = "westus2"
...
postgresql_firewall_rule_variables = {
  "postgresql_firewall_rule_1" = {
    postgresql_firewall_rule_name                = "ploceuspgfw00001"
    postgresql_firewall_rule_resource_group_name = "ploceusrg000001"
    postgresql_firewall_rule_server_name         = "ploceusrg000001"
    postgresql_firewall_rule_start_ip_address    = "40.112.0.0"
    postgresql_firewall_rule_end_ip_address      = "40.112.255.255"
  }
}