...
subnet_variables = {
  ...
  "subnet_2" = {
    ...
    is_delegetion_required                         = false                                                                                                                                                    #update to true if delegation required and update delegation name,service_name,Service_actions
    delegation_name                                = "delegation000001b"                                                                                                                                       #Update this field if delgation required
...
firewall_nat_rule_collection_variables = {
  "firewall_nat_rule_collection_1" = {
    name                       = "ploceusfnr000001"
    resource_group_name        = "ploceusrg000001"
